...
export function Banner(props) {
    ...
    return (
        <div class={classStr}>
            <div class="absolute inset-0 flex justify-center items-center  t-0 l-0 bg-primary-600 h-full w-full  opacity-25">
            </div>
            <div className='flex flex-col  justify-between h-full'>
                <div className="md:pt-28 pt-20 md:px-20 px-10   ">
                    <div className="flex">
                        <h3 className=" capitalize md:text-5xl text-3xl text-secondary-600">{props.title}</h3>
                        <div className="flex  flex-col items-center justify-center pt-4 "><hr className=" h-1  md:w-52 w-36 " /></div>
                    </div>

                    <p className="md:p-10 p-2 text-white text-2xl">{props.desc}</p>
                </div>
...
export function TitleContainer(props) {
    ...
    return (
        <div className="flex items-center justify-center p-4">
            <div className="text-3xl text-secondary-600 underline  font-bold">
                {props.title}
            </div>
        </div>

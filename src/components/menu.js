        ...
        <div className='flex-row w-screen flex px-20 bg-slate-800 '>
            ...
            <div className='py-2  w-full flex-row flex '>
                ...
                <MenuItem title="Services "
                    childr={true}
                    subelements={[{ "name": 'something', "icon": "" },]}
                />
